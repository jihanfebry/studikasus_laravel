    ...
    <table class="table table-stripped table-bordered">
        ...
        <tbody>
            ...
            <td>
                ...
                {{-- karna coloumn medicines tipe datanya berbentuk array json, maka untuk mengaksesnya perlu di looping js --}}
                <ol>
            ...
            {{-- carbo  : package bawaan laravel untuk mengaatur hal2 yg berkaitan dengan tipe data date/dateime--}}
            @php
