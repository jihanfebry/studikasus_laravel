            ...
            <form method="POST" id="form-stock">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" disable>
                    </div>
                    <div class="mb-3">
                        <label for="name" class="form-label">Stock Obat :</label>
...
$(function(){
    if (sessionStorage.reloadAfterPage){
        $('#msg').attr("class", "alert alert-success");
        $('#msg').text(" Berhasil Menambahkan Data Stock");
